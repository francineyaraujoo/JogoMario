...
scoreDisplay = document.getElementById('score'); // Seleciona o elemento onde a pontuação será exibida
...
const checkGameOver = setInterval(() => {
    ...
    const floorPosition3 = floor3.offsetLeft;
        ...
        // Se não houve colisão, atualize a pontuação
         // Incrementa a pontuação por cada loop
    
        // Atualiza a exibição da pontuação na interface do jogo
        var scoreElement = document.getElementById('score');
        if (scoreElement) {
            scoreElement.textContent = 'Pontuação: ' + score; // Atualiza o conteúdo do elemento com a nova pontuação
        }
